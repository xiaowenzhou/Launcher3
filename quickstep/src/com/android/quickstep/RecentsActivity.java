...
public final class RecentsActivity extends StatefulActivity<RecentsState> {
    ...
    protected void setupViews() {
        ...
        mClearAllButton = findViewById(R.id.img_btn_clear_all);
        ...
        mFallbackRecentsView.setOnTaskViewCountChangedListener(count -> mClearAllButton.setVisibility(count>0?View.VISIBLE:View.GONE));
    ...
    private void dismissAllTasks(View view){
        mFallbackRecentsView.dismissAllTasks(view);
    }
