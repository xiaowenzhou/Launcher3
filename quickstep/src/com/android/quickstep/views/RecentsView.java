...
public abstract class RecentsView<ACTIVITY_TYPE extends StatefulActivity<STATE_TYPE>,
    ...
    private TaskViewCountChangedListener mTaskViewCountChangedListener;
    public interface TaskViewCountChangedListener {
        void onTaskViewCountChanged(int count);
    }

    public void setOnTaskViewCountChangedListener(TaskViewCountChangedListener listener){
        mTaskViewCountChangedListener=listener;
    }
    ...
    protected void applyLoadPlan(ArrayList<Task> tasks) {
        ...
        if (tasks == null || tasks.isEmpty()) {
            ...
            if (mTaskViewCountChangedListener!=null){
                mTaskViewCountChangedListener.onTaskViewCountChanged(0);
            }
...
//                addView(mClearAllButton);
//            }
            if (wasEmpty&&mTaskViewCountChangedListener!=null) {
                mTaskViewCountChangedListener.onTaskViewCountChanged(getTaskViewCount());
            }
